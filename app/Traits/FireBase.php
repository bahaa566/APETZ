...
class FireBase
{
    const fcm_server_key = 'AAAASesbImk:APA91bHkd9E-dE02OV_weD5I9BtzUQYrjaWfx_etCOShCL6ZM26Kkq_t2z68chAdopFOA566-eG-hVsxjOMgIKz7yAlKrUIfThLeker0OsfTyyjztFFUu52g2GmaUjh8ALHxjR09uIaN';
    ...
    public static function notification($notifiable, $title, $body, $data)
    {
        ...
        if (!blank($notifiable->fcm_token_android)) {
            self::notifyByFirebase($title, $body, [$notifiable->fcm_token_android], $data, false);
        }
    ...
    {
//        dd($title, $body, $tokens, $data = [], $is_notification );
